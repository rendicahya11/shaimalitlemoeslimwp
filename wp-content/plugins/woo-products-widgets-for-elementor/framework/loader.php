 ...
 * 2. Add unique prefix for the class name, e.g. - Twentyseventeen_Woo_Elementor_Product_Widgets_CX_Loader
 ...
 *     new Twentyseventeen_Woo_Elementor_Product_Widgets_CX_Loader(
 *         array(
...
if ( ! class_exists( 'Woo_Elementor_Product_Widgets_CX_Loader' ) ) {

	/**
	 * Define Woo_Elementor_Product_Widgets_CX_Loader class
	 */
	class Woo_Elementor_Product_Widgets_CX_Loader {
